...
// Ensure, that LoginServieMock does implement LoginServie.
// If this is not the case, regenerate this file with moq.
var _ LoginServie = &LoginServieMock{}

// LoginServieMock is a mock implementation of LoginServie.
//
//	func TestSomethingThatUsesLoginServie(t *testing.T) {
//
//		// make and configure a mocked LoginServie
//		mockedLoginServie := &LoginServieMock{
//			LoginFunc: func(ctx context.Context, name string, pw string) (string, error) {
//				panic("mock out the Login method")
//			},
//		}
//
//		// use mockedLoginServie in code that requires LoginServie
//		// and then make assertions.
//
//	}
type LoginServieMock struct {
...
func (mock *LoginServieMock) Login(ctx context.Context, name string, pw string) (string, error) {
	if mock.LoginFunc == nil {
		panic("LoginServieMock.LoginFunc: method is nil but LoginServie.Login was just called")
	}
	callInfo := struct {
		Ctx  context.Context
		Name string
...
// Check the length with:
//
//	len(mockedLoginServie.LoginCalls())
func (mock *LoginServieMock) LoginCalls() []struct {
	Ctx  context.Context
	Name string
	Pw   string
} {
